...
function createBase(world, isRight, player)
	...
	base.platforms = {{},{},{}}
	if isRight then
		base.platforms[1] = createPlatform(world, 0.03, .92, "assets/platforms/bases/spring.png", 0.8)
		...
		base.platforms[1] = createPlatform(world, .9, .92, "assets/platforms/bases/spring_orange.png", 0.8)
		base.platforms[1].owner = player
