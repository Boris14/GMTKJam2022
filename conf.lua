...
PLAYER1_SCORE_POSITION = {x=0.1, y=0.1}
PLAYER2_SCORE_POSITION = {x=0.85, y=0.1}
TIMER_POSITION = {x=0.48, y=0.02}
PLAYER1_POWERUP_POSITION = {x = 0.1, y = 0.1}
PLAYER2_POWERUP_POSITION = {x = 0.9, y = 0.1}

TIMER_FONT_SIZE = 96
POWERUP_PICKER_TIME = 5
POWERUP_PICK_DELAY = 2
FREEZE_DURATION = 2
